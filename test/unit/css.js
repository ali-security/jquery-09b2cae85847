...
// Excluded for the sealed build: PhantomJS does not reliably flush layout
// before document ready, so .css("width") on a border-box element
// intermittently returns 20px instead of 100px (fails ~2 runs in 3).
